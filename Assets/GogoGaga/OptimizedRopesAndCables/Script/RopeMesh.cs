...
namespace GogoGaga.OptimizedRopesAndCables
{
    ...
    public class RopeMesh : MonoBehaviour
    {
        ...
        [Range(1, 20)] public int radialDivision = 8;
        ...
        public void CreateRopeMesh(Vector3[] points, float radius, int segmentsPerWire)
        {
            ...
            for (int i = 0; i < points.Length; i++)
            {
                ...
                if(segmentsPerWire == 4)
                {
                    rotation = Quaternion.LookRotation(direction, new Vector3(1,1,0));
                }
            ...
            if (segmentsPerWire == 4)
            {
                ...
                endRotation = Quaternion.Euler(endRotation.eulerAngles.x, endRotation.eulerAngles.y, 45f);
            }
